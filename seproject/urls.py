...
urlpatterns = [
    ...
    path('viewHome/<int:home_id>',views.viewHome,name="viewHome"), #หน้าต่อจากหน้า home ของ admin
    ...
    path('checkInfo/<int:user_id>',views.checkInfo,name="checkInfo"),  #ตรวจสอบข้อมูลก่อนสมัครทุน
